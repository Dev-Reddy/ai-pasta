...
export function UnifiedChatInput({ onSendMessage, isLoading, enabledProviders, className }: UnifiedChatInputProps) {
      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-4xl">
        <div className="flex items-end gap-3">
          <Button
            ...
            variant="outline"
            size="icon"
            className="shrink-0 bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white"
          >
          ...
          <div className="flex-1 relative">
            <Textarea
              ...
              placeholder={
                enabledCount > 0 ? `Ask all AI models...` : "Enable at least one AI model to start chatting..."
              }
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="absolute bottom-2 right-2 h-8 w-8 text-gray-400 hover:bg-gray-700 hover:text-white"
            >
