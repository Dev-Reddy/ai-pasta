    ...
    >
      <div className="flex items-center justify-between p-4 border-b border-gray-800">
        <div className="flex items-center gap-2">
          ...
          {!isCollapsed && <h1 className="text-lg font-semibold text-white">AI Fiesta</h1>}
        </div>
              ...
              <Collapsible open={isProjectsOpen} onOpenChange={setIsProjectsOpen}>
                ...
                <CollapsibleContent className="space-y-1 mt-2">
                  ...
                  {hiddenProjectsCount > 0 && (
                    ...
                    >
                      {showAllProjects ? "Show Less" : `Show ${hiddenProjectsCount} More`}
                    </Button>
                  )}
                  ...
                  recentChats.map((chat) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start min-w-0">
                        ...
                        <span className="text-xs text-gray-500">{formatRelativeTime(chat.updatedAt)}</span>
                      </div>
                    </Button>
                  ))
                )}
