...
export function SettingsDialog({ open, onOpenChange, onApiKeysUpdated, onApiKeySaved }: SettingsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Configure your API keys and application settings.</DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="api-keys" className="space-y-4">
            <div className="grid gap-4">
              {Object.entries(AI_PROVIDERS).map(([providerId, provider]) => {
                const hasExistingKey = existingKeys.some((key) => key.provider === providerId)
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            {hasExistingKey ? "API key configured" : "No API key configured"}
                          </CardDescription>
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="icon"
                          onClick={() => toggleShowKey(providerId as AIProvider)}
                        >
                      ...
                      <div className="flex gap-2">
                        <Button
                          onClick={() => handleSaveKey(providerId as AIProvider)}
                        ...
                        {hasExistingKey && (
                          <Button variant="outline" size="sm" onClick={() => handleDeleteKey(providerId as AIProvider)}>
